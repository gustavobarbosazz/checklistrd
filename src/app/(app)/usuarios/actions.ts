...
export async function createUser(formData: FormData) {
  ...
  // Senha temporária aleatória que ninguém vê — o usuário sempre cria a senha
  // de verdade na tela de Primeiro Acesso, obrigatoriamente, no primeiro login.
  ...
  return { success: true, message: 'Usuário criado com sucesso. No primeiro acesso, ele deverá criar uma senha.' };
}
